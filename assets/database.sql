...
CREATE TABLE IF NOT EXISTS `reactions`.`reactions` ( `reactionID` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT, `parentID` BIGINT UNSIGNED NULL DEFAULT NULL, `articleID` BIGINT UNSIGNED NOT NULL, `score` INT NULL DEFAULT 0, `userID` BIGINT UNSIGNED NOT NULL, `publishDate` VARCHAR(45) NOT NULL, `content` TEXT NOT NULL, PRIMARY KEY (`reactionID`), UNIQUE INDEX `reactionID_UNIQUE` (`reactionID` ASC), INDEX `fk_reactions_1_idx` (`parentID` ASC), INDEX `fk_reactions_3_idx` (`userID` ASC), INDEX `fk_reactions_2_idx` (`articleID` ASC), CONSTRAINT `fk_reactions_1` FOREIGN KEY (`parentID`) REFERENCES `reactions`.`reactions` (`reactionID`) ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT `fk_reactions_2` FOREIGN KEY (`articleID`) REFERENCES `reactions`.`articles` (`articleID`) ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT `fk_reactions_3` FOREIGN KEY (`userID`) REFERENCES `reactions`.`users` (`userID`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE = InnoDB;
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `reactions`.`articles` (`articleID`, `title`, `content`) VALUES (152056, 'Delfts studententeam bouwt waterstofvliegtuig', '<p>Lorem ipsum dolor sit amet</p>');
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `reactions`.`reactions` (`reactionID`, `parentID`, `articleID`, `score`, `userID`, `publishDate`, `content`) VALUES (1, NULL, 152056, -1, 1, '2019-04-25 16:20:00', '<p>FIPO!!</p>');
INSERT INTO `reactions`.`reactions` (`reactionID`, `parentID`, `articleID`, `score`, `userID`, `publishDate`, `content`) VALUES (3, 1, 152056, 0, 2, '2019-04-25 17:34:00', '<p>Lorem ipsum? Dolor fipo condimentum nibh erat, a condimentum ligula rutrum sed.</p>');
INSERT INTO `reactions`.`reactions` (`reactionID`, `parentID`, `articleID`, `score`, `userID`, `publishDate`, `content`) VALUES (4, 3, 152056, 1, 1, '2019-04-25 17:55:00', '<p>Suspendisse tellus sapien</p>');
INSERT INTO `reactions`.`reactions` (`reactionID`, `parentID`, `articleID`, `score`, `userID`, `publishDate`, `content`) VALUES (2, NULL, 152056, 3, 3, '2019-04-25 16:24:00', '<p>Lorem ipsum dolor sit amet</p>');
INSERT INTO `reactions`.`reactions` (`reactionID`, `parentID`, `articleID`, `score`, `userID`, `publishDate`, `content`) VALUES (5, 2, 152056, 1, 2, '2019-04-25 16:55:00', '<p>Larem ipsum dolor, dit sit dolor amet</p>');
INSERT INTO `reactions`.`reactions` (`reactionID`, `parentID`, `articleID`, `score`, `userID`, `publishDate`, `content`) VALUES (6, 2, 152056, 1, 4, '2019-04-25 18:12:00', '<p>Suspendisse tellus sapien</p>');
...
INSERT INTO `reactions`.`reactionScores` (`reactionID`, `userID`, `score`) VALUES (3, 1, -1);
INSERT INTO `reactions`.`reactionScores` (`reactionID`, `userID`, `score`) VALUES (4, 3, 1);
INSERT INTO `reactions`.`reactionScores` (`reactionID`, `userID`, `score`) VALUES (2, 4, 3);
INSERT INTO `reactions`.`reactionScores` (`reactionID`, `userID`, `score`) VALUES (5, 1, 1);
INSERT INTO `reactions`.`reactionScores` (`reactionID`, `userID`, `score`) VALUES (6, 1, 1);
