...
if (!is_file($currentPath. 'env.php')) {
    printf(
        'Your environment is not set yet. Please copy %senv.example.php to %senv.php, and adjust the file to your '
        . 'environment. For more information, please see %sINSTALLATION.md' . PHP_EOL,
        $currentPath,
        $currentPath,
        $currentPath
    );
